...
image_folder = 'E:/TextRecounstruction/countries'
...
for filename in os.listdir(image_folder):
    if filename.endswith(('.jpg', '.png', '.jpeg')):  # Add more extensions as needed
        ...
        text_dictionary = ["Karnataka", "apple", "banana", "cherry", "apricot", "apology", "appropriate", "blueberry", "green apple"
                          , "science", "university", "research", "institute", "technology", "master", "storage", "generate",
